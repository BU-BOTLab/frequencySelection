...
%%
%Save MAT FILES
save(sprintf('../generatedData/NA_noise_%dnm_unequalData_optimized.mat',wavelength),'saveMuaTrue','saveMusTrue', 'saveMuaRec','saveMusRec','freqList');
...
sgtitle('mDOSI noise model unequal data optimized 850 nm')
it = 1;
...
print('../plots/ErrorLandscape_NA_850nm_unequalData_optimized_v2.png','-dpng')
