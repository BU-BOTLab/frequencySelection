...
for f=1:length(freqList)
	...
	parfor i=1:numTrials
		...
		%Run inverse model
		recOP = fitMu([noiseReal;noiseImag],wt, fa', nind, sep,'test');
...
%%
%Save MAT FILES
save(sprintf('../generatedData/NA_noise_%dnm_unequalData_default.mat',wavelength),'saveMuaTrue','saveMusTrue', 'saveMuaRec','saveMusRec','freqList');
...
sgtitle('mDOSI noise model unequal data default 850 nm')
it = 1;
...
print('../plots/ErrorLandscape_NA_850nm_unequalData_default_v2.png','-dpng')
