...
%%
    %Save MAT FILES
    save(sprintf('../generatedData/Digital_noise_%dnm_equalData_optimized_v2.mat',wavelength),'saveMuaTrue','saveMusTrue', 'saveMuaRec','saveMusRec','freqList');
...
sgtitle('Digital noise model error single freq optimized')
it = 1;
for thisFreqIdx = 1:3
...
print('../plots/ErrorLandscapeSingleFreq_digital_850nm_optimized_v3.png','-dpng')


f=figure;
set(f,'Position',[230,260,1470,900])
sgtitle('Digital noise model error multi-freq optimized')
it = 1;
for thisFreqIdx = 4:6
    for thisSepIdx = 1:length(sepRange)
        subplot(3,3,it)
...
print('../plots/ErrorLandscapeMultiFreq_digital_850nm_optimized_v3.png','-dpng')