%NA_noisemodel_equalData_LUT_optimized
%
...
%%
%Save MAT FILES
save(sprintf('../generatedData/NA_noise_%dnm_equalData_LUT.mat',wavelength),'saveMuaTrue','saveMusTrue', 'saveMuaRec','saveMusRec','freqList');
