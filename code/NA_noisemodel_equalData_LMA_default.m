...
%%
%Save MAT FILES
save(sprintf('../generatedData/NA_noise_%dnm_equalData_default.mat',wavelength),'saveMuaTrue','saveMusTrue', 'saveMuaRec','saveMusRec','freqList');
...
sgtitle('mDOSI noise model equal data default 850 nm')
it = 1;
...
print('../plots/ErrorLandscape_NA_850nm_equalData_default_v2.png','-dpng')
