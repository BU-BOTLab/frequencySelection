...
for sepIdx = 1:length(sepRange)
    ...
    for f=1:length(freqList)
        ...
        parfor i=1:numTrials
            ...
            %Run inverse model
            recOP = fitMu([rp;ip],wt, fa', nind, sepRange(sepIdx),'test');
...
%%
%Save MAT FILES
save('../generatedData/noNoise_LMA_default.mat', 'saveMuaTrue','saveMusTrue','saveMuaRec','saveMusRec','freqList');
...
sgtitle('No noise error single freq default')
it = 1;
for thisFreqIdx = 1:3
...
print('../plots/ErrorLandscapeSingleFreq_noNoise_LMA_default.png','-dpng')
...
print('../plots/ErrorLandscapeMultiFreq_noNoise_LMA_default.png','-dpng')
